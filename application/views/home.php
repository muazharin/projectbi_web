...
<head>
		...
		<!-- Font Awesome CSS -->
		<link href="<?= base_url();?>assets/assets/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="index.html" class="logo"><img alt="Logo" src="<?= base_url();?>assets/assets/images/logo.png" /> <span>Admin</span></a>
        </div>
			...
			<ul class="list-inline float-right mb-0">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-lg">
						...
						<a href="#" class="dropdown-item notify-item">
							<div class="notify-icon bg-faded">
								<img src="<?= base_url();?>assets/assets/images/avatars/avatar2.png" alt="img" class="rounded-circle img-fluid">
							</div>
						...
						<a href="#" class="dropdown-item notify-item">
							<div class="notify-icon bg-faded">
								<img src="<?= base_url();?>assets/assets/images/avatars/avatar3.png" alt="img" class="rounded-circle img-fluid">
							</div>
							<p class="notify-details">
								<b>Michael Cox</b>
						...
						<a href="#" class="dropdown-item notify-item">
							<div class="notify-icon bg-faded">
								<img src="<?= base_url();?>assets/assets/images/avatars/avatar4.png" alt="img" class="rounded-circle img-fluid">
							</div>
							<p class="notify-details">
				...
				<li class="list-inline-item dropdown notif">
					<a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
						<img src="<?= base_url();?>assets/assets/images/avatars/admin.png" alt="Profile image" class="avatar-rounded">
					</a>
...
<!-- App js -->
<script src="<?= base_url();?>assets/assets/js/pikeadmin.js"></script>
...
<!-- BEGIN Java Script for this page -->
	...
	<script src="<?= base_url();?>assets/assets/plugins/counterup/jquery.counterup.min.js"></script>			
